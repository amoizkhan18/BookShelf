...
const BooksListScreenAction = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Action & adventure');
...
export default BooksListScreenAction;
