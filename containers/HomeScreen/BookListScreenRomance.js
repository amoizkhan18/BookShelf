...
const BooksListScreenRomance = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Romance');
...
export default BooksListScreenRomance;
