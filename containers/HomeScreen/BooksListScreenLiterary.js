...
const BooksListScreenLiterary = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Literary');
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.heading}>LITERARY</Text>
...
export default BooksListScreenLiterary;
