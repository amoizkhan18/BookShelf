...
const BooksListScreenHistory = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/History');
...
export default BooksListScreenHistory;
