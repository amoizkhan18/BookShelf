...
const BooksListScreenTravel = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Travel');
...
export default BooksListScreenTravel;
