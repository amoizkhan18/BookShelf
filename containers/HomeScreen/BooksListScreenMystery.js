...
const BooksListScreenMystery = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Mystery');
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.heading}>MYSTERY</Text>
...
export default BooksListScreenMystery;
