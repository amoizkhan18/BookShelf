...
const BooksListScreenJuvenile = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Juvenile & young adult');
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.heading}>JUVENILE</Text>
...
export default BooksListScreenJuvenile;
