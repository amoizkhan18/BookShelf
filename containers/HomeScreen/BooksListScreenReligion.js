...
const BooksListScreenReligion = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Religion');
...
export default BooksListScreenReligion;
