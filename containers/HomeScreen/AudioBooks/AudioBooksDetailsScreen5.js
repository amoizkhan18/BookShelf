...
const AudioBooksDetailsScreen = ({ navigation }) => {
  ...
  // Hardcoded data
  const genres = ['Horror'];
  const description = 'Edgar Allan Poe is best known for his famous short horror stories; however, horror is not the only genre in which he wrote. How To Write a Blackwood Article and its companion piece A Predicament are satirical works exploring the pieces of the formula generally seen in short horror stories (articles) found in the Scottish periodical "Blackwoods Magazine and the successful misapplication of said formula by - horrors! - a woman author! - respectively. Read by Catharine Eastman';
  const imageurl = 'https://ia601202.us.archive.org/12/items/twopoetales_ce_librivox/Two_Poe_Tales_1206.jpg';
  ...
  const handlePlayPress = () => {
    ...
    navigation.navigate('MusicScreen5');
  };
