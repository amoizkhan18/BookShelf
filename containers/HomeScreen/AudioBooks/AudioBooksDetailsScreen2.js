...
const AudioBooksDetailsScreen = ({ navigation }) => {
  ...
  // Hardcoded data
  const genres = ['Horror'];
  const description = 'The Black Cat; The Fall of the House of Usher, The Raven; The Tell Tale Heart, The Masque of the Red Death, the Premature Burial and six others that are a shuddering delight to read and listen to. Turn off the lights, settle down and hear these stories read to you as only (Summary by Phil Chenevert)';
  const imageurl = 'https://dn790002.ca.archive.org/0/items/12_creepytales_1206_librivox/12_Creepy_Tales_1206.jpg';
  ...
  const handlePlayPress = () => {
    ...
    navigation.navigate('MusicScreen2');
  };
