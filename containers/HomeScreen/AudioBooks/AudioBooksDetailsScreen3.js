...
const AudioBooksDetailsScreen = ({ navigation }) => {
  ...
  // Hardcoded data
  const genres = ['Horror'];
  const description = 'Dramatic Reading read by a full cast. The Ghost Breaker is a drama and haunted house horror complete with heroes, villains, and a Princess. The Ghost Breaker was originally a screenplay and would later be made a drama film directed by Cecil B. DeMille. (Summary by Linette Geisel) Cast: Narrator: Linette Geisel Warren; Ghost Breaker and Kentuckian hero: Bill Mosley Maria Theresa, Princess of Aragon: Amanda Friday Rusty Snow; Warrens servant man:Phil Chenevert Carlos, Duke of Alva, cousin of Maria Theresa: Marty Kris Colonel Jarvis of Meadow Green (older voice): Marty Kris Mandy; Colonel Jarviss servant woman: Jenny Lundak Doctor: Chuck Williamson Major Selby: Nathanial W.C.Higgins Hotel Page: Marty Kris Colonel Jim Marcum, wealthy and prominent Kentucky sportsman';
  const imageurl = 'https://ia600202.us.archive.org/16/items/ghost_breaker_1204_librivox/Ghost_Breaker_1304.jpg';
  ...
  const handlePlayPress = () => {
    ...
    navigation.navigate('MusicScreen3');
  };
