...
const BooksListScreenHorror = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://freeinvoicegenerator.pk/api/books/genres/Horror');
...
export default BooksListScreenHorror;
